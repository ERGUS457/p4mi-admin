  ...
  return (
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-900">Manajemen Agensi / PPTKIS</h1>
          <p className="text-sm text-slate-500">Daftar agensi mitra penempatan luar negeri</p>
        </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 text-center text-slate-500 py-12">
        <p>Belum ada data agensi mitra.</p>
      </div>
    </div>
  );
}
